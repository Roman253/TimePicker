...
export default class Clock extends Component {
  ...
  componentDidUpdate(prevProps, prevState, snapshot){
    if(prevState.currentMinute !== this.state.currentMinute ||
      prevState.currentHour !== this.state.currentHour ||
  ...
  digitsHours() { 
      ...
      for (let i = 1; i < 13 ; ++i) {
        ...
        style={{backgroundColor: this.props.digitsColor, color: this.props.fontsColor}}
        onClick={()=>{
